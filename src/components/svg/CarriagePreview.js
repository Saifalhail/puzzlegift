...
const CarriagePreview = ({ wheels, color, ornament }) => {
  const getWheelStyle = () => {
    return wheels === 'modern' ? (
      <g>
  ...
  const getOrnamentStyle = () => {
    switch (ornament) {
      ...
      case 'horse':
        return (
          <path
            d="M-15 0 Q-10 -15 0 -15 Q10 -15 15 0 Q10 15 0 15 Q-10 15 -15 0"
            fill="#DDD"
          />
        );
      case 'dragon':
  ...
  return (
    ...
    >
      ...
      <g filter="url(#shadow)">
        ...
        {/* Door handle */}
        <circle cx="30" cy="0" r="5" fill="#888" />
      </g>
